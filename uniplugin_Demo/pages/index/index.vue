		...
		data() {
			return {
				...
				},
				{
					...
					name:'插件示例sensor',
					open:false,
					url:'/pages/sample/ext-sensor'
				},
				{
					id:'scaner',
					name:'插件示例scaner',
					open:false,
					url:'/pages/sample/ext-scanner'
				},
				{
					id:'printer',
					name:'插件示例printer',
					open:false,
					url:'/pages/sample/ext-printer'
				},
				{
					id:'office',
					name:'插件示例office',
					open:false,
					url:'/pages/sample/ext-office'
				},
				{
					id:'card',
					name:'插件示例card',
					open:false,
					url:'/pages/sample/ext-card'
				},
				{
					id:'sale',
					name:'插件示例sale',
					open:false,
					url:'/pages/sample/ext-sale'
				}],
				navigateFlag: false
			}
		},
