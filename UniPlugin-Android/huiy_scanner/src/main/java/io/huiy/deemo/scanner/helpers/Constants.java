...
public class Constants {
    ...
    public static final int SCANNERS_HAS_UPDATED = 39;

    public static final int NO_PERMISSIONS = 20;



    public static final String CALL_BACK_INIT = "init";
    public static final String CALL_BACK_CONNECT = "connect";
    public static final String CALL_BACK_DISCONNECT = "disconnect";
