package io.huiy.deemo.scanner.helpers;
...
public interface ScannerAppEngine {
    ...
    /**
     * Method to remove a {@link com.zebra.scannercontrol.app.helpers.ScannerAppEngine.IScannerAppEngineDevListDelegate} from the list of delegates
     * @param delegate Delegate to be added
     */
    void addDevListDelegate(IScannerAppEngineDevListDelegate delegate);

    /**
     * Method to add a {@link com.zebra.scannercontrol.app.helpers.ScannerAppEngine.IScannerAppEngineDevListDelegate} from the list of delegates
     * @param delegate Delegate to be added
     */
